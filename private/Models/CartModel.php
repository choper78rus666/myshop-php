...
class CartModel {
    ...
    function deleteItem($id){
        ...
        $sql = "DELETE cart_item.* FROM cart, cart_item WHERE cart.id_cart = cart_item.id_cart AND (cart.login=:login OR cart.session_id=:session_id) AND cart_item.item_id=:item_id;";
        $this->db->addSQL($params, $sql);
    }
